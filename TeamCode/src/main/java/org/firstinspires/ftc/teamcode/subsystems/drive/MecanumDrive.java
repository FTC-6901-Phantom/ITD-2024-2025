...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.00031247937251857415;
        public double trackWidthTicks = 21355.170345984396;

        // feedforward parameters (in tick units)
        public double kS = 1.2594922796293329;
        public double kV = 0.00008327272419185583;
